...
BOT_TOKEN = environ.get('BOT_TOKEN', "8536587558:AAFv06dPKSdJrNxe2diwHhwGIJGeJNXZgXk")    # Bot token from @BotFather

# ============================
# Bot Settings Configuration
# ============================
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))    # Cache time in seconds (default: 30 minutes)
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002658908912 -100316782058').split()]  # Channel id for auto indexing (make sure bot is admin)
...
AUTH_CHANNEL = int(auth_channels) if auth_channels and id_pattern.search(auth_channels) else None
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Cinema_Lokam_Movies_Group') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Ascreator_10') # Owner link for the bot
