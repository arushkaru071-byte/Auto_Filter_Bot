...
│
<b>╰─────────────────────⍟</b>
<b>ᴛᴏᴛᴀʟ ғɪʟᴇs ɪɴ ʙᴏᴛʜ DB : <code>{}</code></b>"""
...
<blockquote><b>👇 ᴄʜᴏᴏsᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ sᴘᴇʟʟɪɴɢ ᴏғ ᴛʜᴇ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ ғʀᴏᴍ ᴏᴘᴛɪᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ </b></blockquote>"""
...
ᴛʜɪs ɪs ɴᴏᴛ ᴀɴ ᴏᴘᴇɴ sᴏᴜʀᴄᴇ ᴘʀᴏᴊᴇᴄᴛ. ɪᴛ ɪs ᴀɴ ᴘʀɪᴠᴀᴛᴇ ᴏɴᴇ ☻︎ """
